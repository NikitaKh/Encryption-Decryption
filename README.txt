	...
	This command must get data from the file file_name.txt (you have to create file woth content you wish), encrypt the data with the key 5, create a file called protected.txt and write ciphertext to it.
